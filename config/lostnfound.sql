...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Jul 04, 2025 at 01:42 AM
...
CREATE TABLE `found_reports` (
  ...
  `found_report_object_id` int(11) NOT NULL,
...
INSERT INTO `found_reports` (`found_report_id`, `found_report_object_id`, `found_place`, `found_reporting_user_id`, `found_date`, `found_report_extra_comments`) VALUES
(1, 1, 'Cafeteria', 1, '2025-07-03', 'tirados en los sillones ');
...
CREATE TABLE `lost_reports` (
  ...
  `lost_report_object_id` int(11) NOT NULL,
...
INSERT INTO `lost_reports` (`lost_report_id`, `lost_report_object_id`, `lost_place`, `lost_reporting_user_id`, `lost_date`, `lost_report_extra_comments`) VALUES
(1, 2, 'mentoria 205', 1, '2025-07-03', '');
...
CREATE TABLE `objects` (
  ...
  `object_photo` varchar(100) NOT NULL DEFAULT 'default_photo.png',
...
(1, 'redmi buds 6', 'redmi buds 6 color negro', 9, 'redmi_buds_6.jpeg', 'found'),
(2, 'Llaves Nissan', 'Llave de un nissan', 2, 'default_photo.png', 'lost');
...
ALTER TABLE `found_reports`
  ...
  ADD KEY `found_reported_object_id_constraint` (`found_report_object_id`);
...
ALTER TABLE `lost_reports`
  ...
  ADD KEY `lost_reporting_user_id_constraint` (`lost_reporting_user_id`),
  ADD KEY `lost_reported_object_id_constraint` (`lost_report_object_id`) USING BTREE;
...
--
ALTER TABLE `found_reports`
  MODIFY `found_report_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `lost_reports`
--
ALTER TABLE `lost_reports`
  MODIFY `lost_report_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `found_reports`
  ADD CONSTRAINT `found_reported_object_id_constraint` FOREIGN KEY (`found_report_object_id`) REFERENCES `objects` (`object_id`),
...
--
ALTER TABLE `lost_reports`
  ADD CONSTRAINT `lost_reported_object_id_constraint` FOREIGN KEY (`lost_report_object_id`) REFERENCES `objects` (`object_id`),
  ADD CONSTRAINT `lost_reporting_user_id_constraint` FOREIGN KEY (`lost_reporting_user_id`) REFERENCES `users` (`user_id`);
